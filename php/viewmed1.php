...
<img src="../images/plus.jpg" width="100" height="100">
  ...
  <div class='container'>
	...
	{
		$sql = mysqli_query($conn,"select * from medicine where medid='$medid' AND type='medicines'");
		if(!$sql)
		{
			echo ("not sucess");
		}
		...
		{
		    echo "<br> MEDNAME: ".$row['medname']."<br> <br>MFGDATE: ".$row['mfgdate']."<br><br> EXPDATE: ".$row['expdate']."<br><br> PRICE: ".$row['tabprice']."<br>";
		}
		}
		}
		}?>
