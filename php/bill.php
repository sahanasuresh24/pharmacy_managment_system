...
<center><table>
	...
	else
	{
		...
		{  
		   echo "<tr><td>".$row["medid"]."</td><td>" .$row1["medname"]."</td><td>".$row['quantity']."</td><td>".$row1['tabprice']."</td><td>".$row['price']."</td><td><a href='edit.php?id=$id'><img src='../images/edit.png' width='40' height='40' border='0' align= 'middle'></a></td><td><a href='../php/next.php?id=$id'><img src='../images/delete1.png' width='40' height='40' border='0' align= 'middle'></a></td></tr>";		
		}
		}
		}
		}
