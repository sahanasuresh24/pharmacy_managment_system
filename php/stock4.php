...
<div class="topnav">
  ...
  <a class="active" href="#">SKIN CARE PRODUCTS</a>
  <a href="addproducts.php">ADD PRODUCTS</a>
  <a href="cdetails.php">COMPANY</a>
    <div class="search-container">
    <form action="sea4.php" method = "get">
...
<div class="row">
  ...
  <br><br><center><table>
	...
	{
		$sql = mysqli_query($conn,"select * from stock where stock.medid = any(select medid from medicine where type = 'skincareproducts') order by medid ");
		if(!$sql)
		{
			echo ("not sucess");
		}
