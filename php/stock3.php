...
<div class="row">
  ...
  <br><br><center><table>
	...
	{
		$sql = mysqli_query($conn,"select * from stock where stock.medid = any(select medid from medicine where type = 'babycareproducts')order by medid  ");
		if(!$sql)
		{
			echo ("not sucess");
		}
