...
<div class="topnav">
  ...
  <a class="active" href="babycareproducts.php">BABY CARE PRODUCTS</a>
  <a href="skincareproducts.php">SKIN CARE PRODUCTS</a>
    <div class="search-container">
    <form action="seabcp.php" method = "get">
...
<img src="../images/plus.jpg" width="100" height="100">
  ...
  <center><table>
	...
	{
		$sql = mysqli_query($conn,"select * from medicine where medname LIKE '%$medname%' AND type = 'babycareproducts'");
		if(!$sql)
		{
			echo ("not sucess");
		}
